            ...
            switch (index)
            {
                ...
                return new Track()
                {
                    ...
                    Start = new Path()
                    {
                        ...
                        Data = ParsePathGeometry("m 43.118299,89.690132 c -2.191618,0.478994 -4.375473,0.994331 -6.546371,1.56011 3.227194,5.369354 6.454386,10.738708 9.68158,16.108058 1.35278,-1.18327 2.775588,-2.39917 4.557564,-2.8581 0.455353,-0.17992 1.382416,-0.10159 0.788128,-0.69912 -2.826967,-4.703648 -5.653934,-9.407297 -8.480901,-14.110948 z"),
                    },
                    Goal = new Path()
                    {
                ...
                case 1:
                    return new Track()
                    {
                        ...
                        {
                            Fill = ParseBrush("#FF00FF00"),
                            Data = ParsePathGeometry("m 61.006605 28.536099 -4.118094 21.663276 c 0.593434 0.126045 1.195946 0.256381 1.81746 0.397909 2.939093 0.669282 6.057157 1.402506 9.305891 2.135788 l 4.113961 -21.64209 c -2.889906 -0.648275 -5.747528 -1.309738 -8.535397 -1.944585 -0.874308 -0.199096 -1.73237 -0.40414 -2.583821 -0.610298 z"),
                        },
                        Goal = new Path()
                        {
                            Fill = Brushes.Transparent,
